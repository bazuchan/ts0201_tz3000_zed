...
void app_bindOrUnbindIndicate(void *buf) {
    zdo_bindOrUnbindIndicate(buf);
...
//  {USER_DESC_REQ_CLID,                FALSE,  zdo_userDescIndicate},          //DEPRECATED
    ...
    {BIND_REQ_CLID,                     TRUE,   app_bindOrUnbindIndicate},
    {UNBIND_REQ_CLID,                   TRUE,   app_bindOrUnbindIndicate},
