#ifndef SRC_COMMON_BOARD_Z_WXD_H_
#define SRC_COMMON_BOARD_Z_WXD_H_

#if (BOARD == BOARD_Z_WXD)
// _TZ3000_stw9kdvl
...
#define ZCL_BASIC_MODEL_ID  {14,'T','S','0','2','0','1','-','z','2','8','-','S','l','D'}
...
#endif /* (BOARD == BOARD_Z_WXD) */

#endif /* SRC_COMMON_BOARD_Z_WXD_H_ */
